...
# ----------------------------
# Funciones de carga desde Supabase Storage
# ----------------------------
...
# ----------------------------
# Manejo de llamadas a función externa
# ----------------------------
...
async def chat(request: ChatRequest = Body(...)):
    ...
    try:
        ...
        # Si hay llamada a función, la procesamos
        if detected_fc:
            ...
            # Segunda llamada a GPT-4.1 con el resultado de la función
        ...
        # Si no hubo función, devolvemos el texto inicial
